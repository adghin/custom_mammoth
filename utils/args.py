...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--optim_upscale',type=int,default=0,choices=[0,1]help='Upscale images to default size of pre-trained model recipe. 0 (no upscale), 1 (upscale)')
    #END   --- aghin
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb_entity', type=str, default='adghin', help='Wandb entity')
    parser.add_argument('--wandb_project', type=str, default='continual_benchmarks', help='Wandb project name')
